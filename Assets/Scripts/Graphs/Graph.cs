...
public class Graph {
    ...
    public List<GraphNode> pathList = new List<GraphNode>();
    ...
    private GraphNode FindNode(GameObject id) {
    ...
    private void ReconstructPath(GraphNode startId, GraphNode endId) {
    ...
    float distance(GraphNode a, GraphNode b) {

        return Vector3.SqrMagnitude(a.getID().transform.position - b.getID().transform.position);
    }

    int lowestF(List<GraphNode> l) {
